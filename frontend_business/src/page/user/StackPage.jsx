      ...
      <main className="business-register-container">
        <div className="business-register-intro-card">
          ...
          <div className="business-register-intro-section">
            <div className="business-register-intro-text">
              <p>
                Để tiếp tục quản lý và hiển thị doanh nghiệp trên Local
                Assistant HOLA, vui lòng chọn hoặc nâng cấp gói đăng ký phù hợp
                với nhu cầu của bạn.
              </p>
              <ul>
                <li>
                  <strong>BASIC1:</strong> Phù hợp với doanh nghiệp nhỏ, giới
                  hạn số sản phẩm cơ bản.
                </li>
                <li>
                  <strong>VIP1:</strong> Dành cho doanh nghiệp vừa và nhỏ, thêm
                  tính năng ưu tiên hiển thị.
                </li>
                <li>
                  <strong>SV1:</strong> Cho doanh nghiệp lớn, không giới hạn sản
                  phẩm, hỗ trợ cao cấp.
                </li>
              </ul>
              <p>
                Sau khi chọn gói, bạn sẽ được chuyển đến cổng thanh toán. Gói
                đăng ký có hiệu lực trong 30 ngày, bạn có thể gia hạn hoặc thay
                đổi bất cứ lúc nào.
              </p>
            </div>
        ...
        <div className="business-register-tries-left">
          {paymentsTodayCount >= 1 && (
            ...
            >
              Số lượng chọn gói đã bị giới hạn thanh toán trong ngày. Số lượt
              còn lại: {Math.max(0, 5 - paymentsTodayCount)}
            </p>
          )}
        </div>
      </main>
